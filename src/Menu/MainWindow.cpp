...
void MainWindow::changeStyle() {
    ...
    if (QFile::exists(QCoreApplication::applicationDirPath() + "/res/style/style.qss")) {
        stylePath = QCoreApplication::applicationDirPath() + "/res/style/style.qss";
    } else {
        stylePath = ":/style/style_default.qss";
        QFile::copy(stylePath, QCoreApplication::applicationDirPath() + "/res/style/style.qss");
    }
