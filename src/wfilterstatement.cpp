...
WFilterStatement::WFilterStatement(QWidget*parent) : QWidget(parent), ui(new Ui::WFilterStatement) {
    ui->setupUi(this);
...
void WFilterStatement::saveIni() {
    ...
    out << this->fileList << ui->lineEdit_fenge->text() << ui->lineEdit_wordnum->text() << 0 // ui->lineEdit_time->text()
